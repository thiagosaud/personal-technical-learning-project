...
## 🗂️ Structure
    ...
    │       └── security-schedule.yml                   # Scheduled security scanning and static analysis workflow
    │
    ...
    │   └── create-github-release.sh                    # Automated GitHub release creation script
    │
...
Run the scheduled security workflow:
